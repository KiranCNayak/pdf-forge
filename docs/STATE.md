...
- gzip via `CompressionStream`, the `BroadcastChannel` same-tab shortcut, and the
  manual-paste fallback for when signaling is unreachable — all named in the doc, none
  built yet.
