...
120 Go tests pass. TypeScript is clean. Production build works. 60 Playwright e2e tests
across 23 spec files pass (`web/e2e/`, `npm run test:e2e`) — every tool has at least one.
`__smoke()` now has 12
