...
111 Go tests pass. TypeScript is clean. Production build works. 55 Playwright e2e tests
across 21 spec files pass (`web/e2e/`, `npm run test:e2e`) — every tool has at least one.
`__smoke()` now has 12
